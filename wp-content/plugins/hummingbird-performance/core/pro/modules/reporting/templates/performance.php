	...
	<tr style="padding: 0; text-align: left; vertical-align: top;">
		<td class="main-content-text" style="-moz-hyphens: auto; -webkit-hyphens: auto; border-collapse: collapse !important; color: #1A1A1A; font-family: Roboto, Arial, sans-serif; font-size: 15px; font-weight: normal; hyphens: auto; line-height: 30px; margin: 0; padding: 0; text-align: left; vertical-align: top; word-wrap: break-word;">
			...
			<?php if ( $params['SHOW_METRICS'] ) : ?>
				...
				<p style="color: #1A1A1A;font-family: Roboto, Arial, sans-serif;font-size: 14px;letter-spacing: -0.23px;line-height: 22px;margin: 0 0 30px;padding: 0;text-align: left;">
					<?php esc_html_e( 'Your performance score is calculated based on how your site performs in each of the following 5 metrics.', 'wphb' ); ?>
				</p>
				...
				<table class="reports-list" align="center" style="border-collapse: collapse;border-spacing: 0;margin: 0 0 30px;padding: 0;text-align: left;vertical-align: top;width: 100%">
					...
					<?php foreach ( $last_test->desktop->metrics as $index => $metric ) : ?>
						<?php
						if ( ! in_array( $index, Utils::get_performance_metrics(), true ) ) {
							continue;
						}
						?>
				...
				<table class="reports-list" align="center" style="border-collapse: collapse;border-spacing: 0;margin: 0 0 30px;padding: 0;text-align: left;vertical-align: top;width: 100%">
					...
					<?php else : ?>
						...
						<tr class="report-list-item" style="padding: 0;text-align: left;vertical-align: top">
							<td class="report-list-item-info" style="border-collapse: collapse !important;color: #1A1A1A;font-family: Roboto, Arial, sans-serif;font-size: 13px;font-weight: 500;line-height: 22px;margin: 0;padding: 10px 0;text-align: left;vertical-align: top">
								<span style="color: inherit; display: inline; font-size: inherit; font-family: inherit; line-height: inherit; vertical-align: middle; letter-spacing: -0.25px; padding-left: 20px;"><?php esc_html_e( 'Interaction to Next Paint (INP)', 'wphb' ); ?></span>
							</td>
							<?php if ( 'both' === $params['DEVICE'] || 'desktop' === $params['DEVICE'] ) : ?>
								<td class="report-list-item-info" style="border-collapse: collapse !important;color: #1A1A1A;font-family: Roboto, Arial, sans-serif;font-size: 13px;font-weight: 500;line-height: 22px;margin: 0;padding: 10px 0;text-align: right;vertical-align: top">
									<span style="color: inherit; display: inline; font-size: inherit; font-family: inherit; line-height: inherit; vertical-align: middle;letter-spacing: -0.25px">
										<?php
										/* translators: %s - number of seconds */
										printf( '%s s', esc_html( $last_test->desktop->field_data->INTERACTION_TO_NEXT_PAINT->percentile ) );
										?>
									</span>
									<?php if ( 'FAST' === $last_test->desktop->field_data->INTERACTION_TO_NEXT_PAINT->category ) : ?>
										<img src="<?php echo esc_url( WPHB_DIR_URL . 'core/pro/modules/reporting/templates/images/icon-success.png' ); ?>" alt="<?php esc_attr_e( 'Ok', 'wphb' ); ?>" style="-ms-interpolation-mode: bicubic; border: none; clear: both; float: right; display: inline-block; margin: 4px 20px 0 5px; height: 16px; outline: none; text-decoration: none; width: auto; vertical-align: middle;" />
									<?php elseif ( 'AVERAGE' === $last_test->desktop->field_data->INTERACTION_TO_NEXT_PAINT->category ) : ?>
										<img src="<?php echo esc_url( WPHB_DIR_URL . 'core/pro/modules/reporting/templates/images/icon-warning.png' ); ?>" alt="<?php esc_attr_e( 'Warning', 'wphb' ); ?>" style="-ms-interpolation-mode: bicubic; border: none; clear: both; float: right; display: inline-block; margin: 4px 20px 0 5px; height: 16px; outline: none; text-decoration: none; width: auto; vertical-align: middle;" />
									<?php elseif ( 'SLOW' === $last_test->desktop->field_data->INTERACTION_TO_NEXT_PAINT->category ) : ?>
										<img src="<?php echo esc_url( WPHB_DIR_URL . 'core/pro/modules/reporting/templates/images/icon-error.png' ); ?>" alt="<?php esc_attr_e( 'Critical', 'wphb' ); ?>" style="-ms-interpolation-mode: bicubic; border: none; clear: both; float: right; display: inline-block; margin: 4px 20px 0 5px; height: 16px; outline: none; text-decoration: none; width: auto; vertical-align: middle;" />
									<?php endif; ?>
								</td>
							<?php endif; ?>
							<?php if ( 'both' === $params['DEVICE'] || 'mobile' === $params['DEVICE'] ) : ?>
								<td class="report-list-item-result ok" style="border-collapse: collapse !important;color: #1A1A1A;font-family: Roboto, Arial, sans-serif;font-size: 13px;font-weight: 500;line-height: 22px;margin: 0;min-width: 65px;padding: 10px 0;text-align: right;vertical-align: top">
									<span style="color: inherit; display: inline; font-size: inherit; font-family: inherit; line-height: inherit; vertical-align: middle;letter-spacing: -0.25px">
										<?php
										/* translators: %s - number of seconds */
										printf( '%s s', esc_html( $last_test->mobile->field_data->INTERACTION_TO_NEXT_PAINT->percentile ) );
										?>
									</span>
									<?php if ( 'FAST' === $last_test->mobile->field_data->INTERACTION_TO_NEXT_PAINT->category ) : ?>
										<img src="<?php echo esc_url( WPHB_DIR_URL . 'core/pro/modules/reporting/templates/images/icon-success.png' ); ?>" alt="<?php esc_attr_e( 'Ok', 'wphb' ); ?>" style="-ms-interpolation-mode: bicubic; border: none; clear: both; float: right; display: inline-block; margin: 4px 20px 0 5px; height: 16px; outline: none; text-decoration: none; width: auto; vertical-align: middle;" />
									<?php elseif ( 'AVERAGE' === $last_test->mobile->field_data->INTERACTION_TO_NEXT_PAINT->category ) : ?>
										<img src="<?php echo esc_url( WPHB_DIR_URL . 'core/pro/modules/reporting/templates/images/icon-warning.png' ); ?>" alt="<?php esc_attr_e( 'Warning', 'wphb' ); ?>" style="-ms-interpolation-mode: bicubic; border: none; clear: both; float: right; display: inline-block; margin: 4px 20px 0 5px; height: 16px; outline: none; text-decoration: none; width: auto; vertical-align: middle;" />
									<?php elseif ( 'SLOW' === $last_test->mobile->field_data->INTERACTION_TO_NEXT_PAINT->category ) : ?>
										<img src="<?php echo esc_url( WPHB_DIR_URL . 'core/pro/modules/reporting/templates/images/icon-error.png' ); ?>" alt="<?php esc_attr_e( 'Critical', 'wphb' ); ?>" style="-ms-interpolation-mode: bicubic; border: none; clear: both; float: right; display: inline-block; margin: 4px 20px 0 5px; height: 16px; outline: none; text-decoration: none; width: auto; vertical-align: middle;" />
									<?php endif; ?>
								</td>
							<?php endif; ?>
